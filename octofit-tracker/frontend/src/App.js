      ...
      <div className="App">
        ...
        <div className="container">
          <Routes>
            ...
            <Route path="/" element={<div className="card p-4 mt-4"><h2 className="display-5">Bienvenido a Octofit Tracker</h2><p className="lead">Tu app de fitness para equipos, actividades, y retos.</p></div>} />
          </Routes>
        </div>
      </div>
    </Router>
